# ==============================================
# APLIKASI siLATIH - BJKW VI MAKASSAR (VERSI 2.3 LENGKAP)
# Fitur: Alat Capaian Output + Unggah File + Isi Manual + Grafik Lengkap
# ==============================================
...
Aplikasi resmi untuk informasi jabatan SKKNI, pengelolaan pelatihan, pendaftaran uji kompetensi, serta pemantauan capaian kinerja anggaran.
</div>
""", unsafe_allow_html=True)
...
if pelatihan_akan:
    for latih, status in pelatihan_akan:
        ...
        Pendaftaran: {latih['buka_daftar']} s.d {latih['tutup_daftar']}<br>
